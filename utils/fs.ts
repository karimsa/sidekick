...
export async function getLatestUpdatedFile(directory: string): Promise<[string, number] | null> {
...
export async function getFilesChangedAfter(directory: string, timestamp: Date): Promise<string[]> {
