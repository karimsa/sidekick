...
export class ProcessManager {
    ...
    static async pause(name: string) {
        await ExecUtils.treeKill(await this.getPID(name), os.constants.signals.SIGSTOP);
    }

    static async resume(name: string) {
        await ExecUtils.treeKill(await this.getPID(name), os.constants.signals.SIGCONT);
    }
